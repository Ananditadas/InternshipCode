window.onload = function(){
  ...
  var ref = firebase.database().ref('professions/physio');

  var doctors = new Array();//array containing the doctors inoformation.


  firebase.database().ref('professions/physio').on('value', function(snapshot) {
    ...
    for(var i=0;i<doctors.length;i++)
    {
      ...
      var details = "";
      details="<h3>Dr "+doctors[i].first_name+" "+doctors[i].last_name+"</h3></br></br><p class=details>"+doctors[i].degrees+"</br>Physiotherapist</br>Experience: <span id=ep>"+doctors[i].experience+"</span> years</br>"+doctors[i].services[0]+" Rs.<span id=rate>"+doctors[i].rates[0]+"</span>/-";
