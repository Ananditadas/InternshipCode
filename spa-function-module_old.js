	...
	function generateServiceDivMobile(x,serflag)
	{
        ...
        $('#checkout').click(function(){
            window.localStorage.setItem("selected_services", JSON.stringify(selected_services));
            window.localStorage.setItem("service_per_head", JSON.stringify(service_per_head));
